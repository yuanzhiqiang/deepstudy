 ...
 *
 */
public class VoteMsgDomain {
  private boolean isInquiry; // true 代表查询请求; false 代表投票请求
  ...
  public VoteMsgDomain(boolean isResponse, boolean isInquiry, int candidateID, long voteCount)
